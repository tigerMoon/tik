...
function envelopeWithOperatorComments(
  comments: NonNullable<RuntimeContextEnvelope['conversation']['operatorComments']> | undefined,
  ...
  return {
    bootstrap: {
      ...
      env: {},
    } as RuntimeContextEnvelope['bootstrap'],
    execution: {
      environment: undefined,
    } as unknown as RuntimeContextEnvelope['execution'],
    conversation: {
      recentMessages: [],
