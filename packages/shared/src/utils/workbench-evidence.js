...
export function extractModifiedFilesFromEvidenceBody(body) {
...
function extractGitModifiedPaths(body) {
    return body
        .split('\n')
        .flatMap((line) => {
...
function parseGitDiffPath(line) {
...
function stripGitRenamePrefix(pathPart) {
...
function normalizeGitPath(pathPart) {
...
//# sourceMappingURL=workbench-evidence.js.map