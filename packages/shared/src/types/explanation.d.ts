 ...
 */
export type ExplanationStatus = 'completed' | 'converged' | 'feedback' | 'failed' | 'blocked' | 'cancelled' | 'unknown';
...
export interface ExplanationBlocker {
    type: 'external_repo_error' | 'missing_context' | 'tool_failure' | 'llm_failure' | 'needs_human' | 'replan_required' | 'runtime_blocker' | 'unknown';
    message: string;
    projectName?: string;
    phase?: string;
    evidence?: string[];
