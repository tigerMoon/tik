...
export type WorkspacePhase = 'WORKSPACE_SPLIT' | 'PARALLEL_CLARIFY' | 'PARALLEL_SPECIFY' | 'PARALLEL_PLAN' | 'PARALLEL_ACE' | 'FEEDBACK_ITERATION' | 'COMPLETED';
export type WorkspaceWorkflowPolicyProfile = 'balanced' | 'fast-feedback' | 'deep-verify';
export type WorkspaceWorktreeMode = 'disabled' | 'managed';
export type WorkspaceWorktreeBranchStrategy = 'auto-create' | 'reuse-existing';
export type WorkspaceWorktreeRetention = 'retain' | 'cleanup';
export type WorkspaceWorktreeNonGitStrategy = 'block' | 'source' | 'copy';
export type WorkspaceProjectWorktreeKind = 'git-worktree' | 'source' | 'copy';
export type WorkspaceProjectWorktreeStatus = 'pending' | 'ready' | 'failed' | 'archived' | 'removed' | 'source';
export type WorkspaceDecisionPhase = 'PARALLEL_CLARIFY' | 'PARALLEL_SPECIFY' | 'PARALLEL_PLAN' | 'PARALLEL_ACE';
export type WorkspaceDecisionKind = 'clarification' | 'approach_choice' | 'phase_reroute' | 'approval';
