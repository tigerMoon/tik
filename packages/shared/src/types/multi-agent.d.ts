...
export type MultiAgentWorkflowStatus = 'created' | 'questioning_requirements' | 'planning' | 'task_graph_questioning' | 'active' | 'blocked' | 'human_review_required' | 'completed' | 'aborted' | 'failed';
export type WorkflowDecisionAction = 'ask_claude_question_requirement' | 'ask_claude_question_task_graph' | 'request_dynamic_plan' | 'draft_contract' | 'ask_claude_question_contract' | 'accept_contract' | 'execute_subtask' | 'record_implementation' | 'run_codex_evaluator' | 'validate_subtask' | 'ask_claude_question_evaluation' | 'fix_evaluation_findings' | 'request_claude_review' | 'fix_claude_blockers' | 're_evaluate' | 'request_re_review' | 'request_replan' | 'skip_non_blocking_suggestions' | 'request_human_review' | 'complete_subtask' | 'run_final_evaluation' | 'ask_claude_question_final_evidence' | 'request_final_review' | 'complete_workflow' | 'abort_workflow';
...
export type GuardResultCode = 'ok' | 'invalid_transition' | 'missing_contract' | 'contract_not_accepted' | 'missing_implementation_evidence' | 'missing_evaluation_result' | 'evaluation_not_passed' | 'evaluation_evidence_insufficient' | 'blocking_question_unresolved' | 'head_sha_mismatch' | 'readonly_policy_violated' | 'max_rounds_exceeded' | 'worktree_out_of_scope' | 'missing_subagent_invocation' | 'subagent_thread_not_isolated' | 'missing_evidence' | 'requires_human_approval' | 'unknown_error';
...
export type SubtaskRunStatus = 'pending' | 'ready' | 'contract_drafting' | 'contract_questioning' | 'contract_accepted' | 'building' | 'executing' | 'implemented' | 'evaluating' | 'validating' | 'evaluation_failed' | 'evaluation_passed' | 'validated' | 'validation_failed' | 'questioning_evidence' | 'reviewing' | 'needs_fix' | 'fixing' | 'review_approved' | 'approved' | 'done' | 'blocked' | 'human_review_required';
...
export type MultiAgentEvidenceKind = 'implementation' | 'validation' | 'evaluation' | 'questioner' | 'review' | 'fix' | 'plan' | 'decision' | 'note';
...
export interface LoopGateDecision extends WorkflowDecision {
    action: 'complete_subtask' | 'fix_claude_blockers' | 'request_re_review' | 'request_replan' | 'request_human_review' | 'complete_workflow';
}
export type MultiAgentWorkflowEventType = 'workflow.created' | 'workflow.policy.updated' | 'workflow.human_override' | 'decision.recorded' | 'task_graph.created' | 'context_snapshot.recorded' | 'contract.created' | 'contract.accepted' | 'contract.staled' | 'subtask.selected' | 'subtask.updated' | 'evidence.recorded' | 'evaluation.created' | 'evaluation.updated' | 'evaluation.result.recorded' | 'evaluation.readonly_validated' | 'questioner.output.recorded' | 'agent_invocation.created' | 'agent_invocation.started' | 'agent_invocation.completed' | 'invocation.stalled' | 'codex.execute.started' | 'codex.execute.completed' | 'validation.started' | 'validation.completed' | 'claude.review.requested' | 'claude.review.started' | 'claude.review.completed' | 'codex.fix.started' | 'codex.fix.completed' | 'replan.requested' | 'human_review.requested' | 'workflow.completed' | 'workflow.aborted';
...
export type LoopStopCondition = 'guard_rejected' | 'same_failure_repeated' | 'head_sha_changed' | 'human_required' | 'budget_exceeded' | 'evaluation_inconclusive';
export type LoopRefreshAction = 'read_latest_head_sha' | 'read_observed_git_diff' | 'reload_task_graph' | 'reload_contract' | 'reload_latest_evidence';
...
export interface QuestionerOutput {
    ...
    artifactRef?: string;
    intent: 'question_requirement' | 'question_task_graph' | 'question_contract' | 'question_evaluation' | 'question_fix' | 'question_final_evidence';
    actor: {
        kind: 'claude-code-questioner';
        invocationId?: string;
        model?: string;
    };
    verdict: 'need_clarification' | 'contract_ready' | 'evidence_sufficient' | 'risk_found' | 'no_blocking_questions' | 'questions_blocking' | 'questions_non_blocking' | 'human_review_required';
    questions: Array<{
        id: string;
        priority: 'blocking' | 'important' | 'optional';
        question: string;
        whyItMatters: string;
        expectedAnswerType: 'requirement' | 'constraint' | 'acceptance_criterion' | 'test_case' | 'edge_case' | 'architecture_decision' | 'evidence' | 'human_decision';
    }>;
    risks: Array<{
        id: string;
    ...
    suggestedContractChanges: Array<{
        target: 'acceptanceCriteria' | 'validationCommands' | 'playwrightScenarios' | 'apiChecks' | 'dbChecks' | 'negativeChecks';
        change: string;
        reason: string;
    }>;
    createdAt: string;
