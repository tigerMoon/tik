...
export type WorkflowSubtaskContract = 'CLARIFY_SUBTASK' | 'SPECIFY_SUBTASK' | 'PLAN_SUBTASK' | 'ACE_SUBTASK';
export type WorkflowAgentRole = 'planner' | 'executor' | 'reviewer';
export type WorkflowSkillName = 'superpowers-clarify' | 'sdd-specify' | 'sdd-plan' | 'ace-sdd-workflow';
export type WorkflowSkillSourceKind = 'agents' | 'superpowers';
...
export type WorkflowSubtaskExecutionState = 'prepared' | 'running' | 'completed' | 'blocked' | 'failed';
