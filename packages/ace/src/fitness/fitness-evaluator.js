...
export class FitnessEvaluator {
    ...
    checkCriticalGates(metrics) {
        return (metrics.buildSuccess &&
            metrics.blockerCount === 0 &&
            metrics.breakingChanges === 0);
    }
    computePenalties(metrics) {
        const penalties = [];
...
//# sourceMappingURL=fitness-evaluator.js.map