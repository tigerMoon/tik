...
import { LocalWorkflowSkillRuntimeAdapter, } from './workflow-skill-runtime.js';
export function createWorkspaceSkillExecutorRegistry(options) {
    ...
    registry.register('SPECIFY_SUBTASK', async ({ spec, subtask, onProviderEvent }) => {
    ...
    registry.register('PLAN_SUBTASK', async ({ spec, subtask, onProviderEvent }) => {
    ...
    registry.register('ACE_SUBTASK', async ({ spec, subtask }) => {
        return {
...
async function materializeWorkspaceSpec(spec, summary, completion, skillRuntime, onProviderEvent) {
...
async function materializeWorkspacePlan(spec, summary, completion, skillRuntime, onProviderEvent) {
...
function buildSkillBoundPrompt(skill, taskPrompt) {
    return [
...
export async function isWorkspacePlanValid(planPath) {
    try {
...
//# sourceMappingURL=workspace-skill-executors.js.map