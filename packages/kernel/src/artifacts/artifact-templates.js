export const ARTIFACT_TEMPLATE_NAMES = [
    'task-review',
    'pr-walkthrough',
...
function renderTaskReviewTemplate(input) {
...
function renderSectionedTemplate(input, titlePrefix, kind, sections) {
    const content = [
...
function placeholderForSection(section) {
    return `- ${section} details will be filled from task evidence during review.`;
}
//# sourceMappingURL=artifact-templates.js.map