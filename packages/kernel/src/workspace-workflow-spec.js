export const WORKSPACE_WORKFLOW_SPEC = {
    PARALLEL_CLARIFY: {
...
export function getWorkspaceWorkflowPhaseSpec(phase) {
    return WORKSPACE_WORKFLOW_SPEC[phase];
}
export function getWorkspaceWorkflowPhaseSpecByContract(contract) {
...
//# sourceMappingURL=workspace-workflow-spec.js.map