...
export class WorkspaceExecutionContractSynthesizer {
    ...
    buildGenericContract(projectPath, sourceText, demand) {
        ...
        const candidateFiles = rankCandidateFiles([...explicitPaths, ...classCandidates, ...functionCandidates, ...inferredTests], sourceText, validationTargets);
    ...
    resolveClassCandidates(projectPath, classNames) {
    ...
    resolveFunctionCandidates(projectPath, functionNames) {
...
function extractValidationTargets(sourceText) {
    return sourceText
        .split('\n')
        .map((line) => line.trim())
...
function buildValidationTargetsFromDemand(demand, inferredTests, functionCalls) {
    const targets = [];
...
function rankCandidateFiles(files, sourceText, validationTargets) {
...
function mergeCandidateFiles(primary, secondary) {
...
//# sourceMappingURL=workspace-execution-contract-synthesizer.js.map