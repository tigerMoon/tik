...
import { assertRuntimeCwd, attachProcessLogs, buildRuntimeProcessEnv, childCompletion, promiseCompletion, } from './runtime-process.js';
...
export class CodexRunner {
    ...
    async start(input) {
        ...
        if (input.mode === 'codex_app_server') {
            ...
            const completion = promiseCompletion(adapter.runTurn({
            ...
            const completion = childCompletion('codex', child, logAttachment.writers, (status) => {
