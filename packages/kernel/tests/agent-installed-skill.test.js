...
function createMockLLM(onPrompt) {
    return {
        name: 'mock',
        async chatWithContext(_messages, systemPrompt) {
...
describe('agent installed skill prompt support', () => {
    ...
    it('loads an installed skill prompt and appends it to the agent instructions', async () => {
        ...
        let seenPrompt = '';
        const runtime = new AgentRuntime(spec, createMockLLM((prompt) => { seenPrompt = prompt; }), {
...
//# sourceMappingURL=agent-installed-skill.test.js.map