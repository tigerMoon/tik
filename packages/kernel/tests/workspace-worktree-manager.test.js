...
describe('WorkspaceWorktreeManager', () => {
    it('derives deterministic branch and workspace-local worktree paths', async () => {
        ...
        expect(manager.buildManagedWorktreePath('/workspace/root', 'service-a', '/repo/service-a')).toMatch(/\/\.workspace\/worktrees\/service-a-[a-f0-9]{8}$/);
        expect(manager.buildManagedWorktreeBranch('Demo Workspace', 'service-a', '/repo/service-a', 'feature a')).toMatch(/^tik\/demo-workspace\/service-a-[a-f0-9]{8}--feature-a$/);
        expect(manager.buildManagedWorktreePath('/workspace/root', 'service-a', '/repo/service-a', 'feature a')).toMatch(/\/\.workspace\/worktrees\/service-a-[a-f0-9]{8}--feature-a$/);
    });
...
//# sourceMappingURL=workspace-worktree-manager.test.js.map