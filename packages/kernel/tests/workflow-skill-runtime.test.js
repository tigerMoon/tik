...
import { buildWorkflowSkillDelegatedDescription, LocalWorkflowSkillRuntimeAdapter, materializeWorkflowSkillDelegatedSpec, parseSkillDescription, } from '../src/workflow-skill-runtime.js';
const tempDirs = [];
afterEach(async () => {
...
describe('workflow skill runtime adapter', () => {
    ...
    it('materializes a delegated subtask description that embeds the bound skill instructions', async () => {
        ...
        const delegated = buildWorkflowSkillDelegatedDescription(spec, {
            skillName: 'sdd-specify',
            skillPath: '/tmp/sdd-specify/SKILL.md',
            description: 'Generate a spec',
            prompt: [
...
//# sourceMappingURL=workflow-skill-runtime.test.js.map