...
describe('WorkbenchStore', () => {
    ...
    it('tolerates malformed session snapshots and trailing partial timeline lines', async () => {
        ...
        await fs.writeFile(path.join(root, '.tik', 'workbench', 'timelines', 'wb-task-robust.jsonl'), `${JSON.stringify(goodTimelineItem)}\n{"id":"msg-partial"`, 'utf-8');
...
async function runWithDelayedFirstIndexWrite(store, action) {
    const storeWithPrivateMethods = store;
...
//# sourceMappingURL=workbench-store.test.js.map