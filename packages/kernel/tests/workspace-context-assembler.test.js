...
describe('WorkspaceContextAssembler', () => {
    ...
    it('embeds the synthesized execution contract into ace delegated tasks', () => {
        ...
        expect(spec.inputs.executionContract?.targetFiles).toContain('catalog-suite-application/src/main/java/com/example/catalog/service/category/impl/CategoryQueryServiceImpl.java');
...
//# sourceMappingURL=workspace-context-assembler.test.js.map