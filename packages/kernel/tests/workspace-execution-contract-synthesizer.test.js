...
describe('WorkspaceExecutionContractSynthesizer', () => {
    it('synthesizes the catalog-items category contract for catalog-suite demands', () => {
        ...
        expect(contract?.targetFiles).toContain('catalog-suite-application/src/main/java/com/example/catalog/service/category/impl/CategoryQueryServiceImpl.java');
...
//# sourceMappingURL=workspace-execution-contract-synthesizer.test.js.map