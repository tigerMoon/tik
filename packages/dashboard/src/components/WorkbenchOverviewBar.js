...
export function WorkbenchOverviewBar({ tasks, packs, activePackId, activeTask, selectedLens, onSelectLens, }) {
    ...
    return (<header style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <FocusCard headline={focus.headline} detail={focus.detail} selected={selectedLens === focus.lens} onClick={() => onSelectLens(focus.lens)}/>
...
function MetricCard({ label, value, hint, tone, active = false, onClick, }) {
    const accent = {
        rose: '#fb7185',
        cyan: '#67e8f9',
        amber: '#fbbf24',
...
function FocusCard({ headline, detail, selected, onClick, }) {
    return (<button type="button" onClick={onClick} style={{
            borderRadius: '18px',
...
//# sourceMappingURL=WorkbenchOverviewBar.js.map