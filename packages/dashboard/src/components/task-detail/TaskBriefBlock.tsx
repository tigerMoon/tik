...
export function TaskBriefBlock({
  task,
  savingAdjustment,
  revertingAdjustment,
  onApplyTaskAdjustment,
  ...
  return (
    <section className="task-detail-brief">
      ...
      {description ? (
        <p className="task-detail-brief-body">{description}</p>
      ) : (
        <p className="task-detail-brief-body is-empty">No description yet. Edit the brief to add one.</p>
      )}

      {editing ? (
        <div className="task-detail-brief-editor">
            ...
            <button
              ...
              onClick={async () => {
                try {
                  ...
                  setFeedback((err as Error).message || 'Unable to save task guidance.');
                }
              }}
            >
            ...
            <button
              ...
              onClick={async () => {
                try {
                  ...
                  setFeedback((err as Error).message || 'Unable to revert guidance.');
                }
              }}
            >
