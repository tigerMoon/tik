...
import { buildEnvironmentActivationSummary, buildEnvironmentPromotionQueue, buildEnvironmentWorkflowCoverage, countEnvironmentPromotionItems, getEnvironmentPackStatusBadge, } from './environment.js';
const PACK = {
...
describe('environment view models', () => {
    ...
    it('builds activation summaries from bound task state', () => {
        ...
        expect(buildEnvironmentActivationSummary(PACK, tasks, 'commerce-ops', '2026-04-13T10:03:00.000Z')).toEqual({
