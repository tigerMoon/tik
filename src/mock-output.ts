...
<head>
  ...
  <title>实现一个贪吃蛇游戏: Ship the latest cartoon snake pass

Adjustment note: 开通风格实现</title>
  <style>
...
<body>
  <main class="shell">
    <section class="hero">
      <div>
        <h1>实现一个贪吃蛇游戏: Ship the latest cartoon snake pass

Adjustment note: 开通风格实现</h1>
